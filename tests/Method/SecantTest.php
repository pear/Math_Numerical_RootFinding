...
if (!defined('PHPUnit_MAIN_METHOD')) {
	define('PHPUnit_MAIN_METHOD', 'Math_Numerical_RootFinding_SecantTest::main');
}
...
class Math_Numerical_RootFinding_SecantTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Math_Numerical_RootFinding Secant Test');
